...
const { listReplies } = require("../lib/comments");
...
/**
 * GET /api/v1/scenes/{sceneId}/comments/{commentId}/replies
 *
 * List replies to a top-level comment, oldest first.
 */
exports.handler = async (event) => {
  ...
  const { replies, lastEvaluatedKey } = await listReplies({
    sceneId,
    parentCommentId,
    limit,
    exclusiveStartKey,
