...
const { createReply, validateBody } = require("../lib/comments");
...
/**
 * POST /api/v1/scenes/{sceneId}/comments/{commentId}/replies
 *
 * Reply to a top-level comment on a visible scene. Replies are one level
 * deep — replying to a reply is rejected by lib/comments.createReply.
 */
exports.handler = async (event) => {
  ...
  const parentCommentId = event.pathParameters?.commentId;
