...
export default function BrandMark({ href = "/", className, wordmarkClassName }: BrandMarkProps) {
  return (
    <Link href={href} className={cn("group flex items-center gap-2.5", className)}>
      <span className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-gradient-to-br from-[var(--nord-teal)] to-[var(--nord-teal)] text-[var(--nord-ink)] shadow-[0_2px_10px_rgba(25,194,173,0.35)] transition-transform group-hover:scale-105">
