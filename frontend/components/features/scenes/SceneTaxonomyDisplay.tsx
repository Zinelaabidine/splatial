      ...
      {hasCategory ? (
        linkFilters ? (
          <Link
            ...
            className="inline-flex rounded-md bg-white/[0.06] px-1.5 py-0.5 text-[10px] font-medium uppercase tracking-wide text-[#c0c0c8] ring-1 ring-white/10 transition-colors hover:bg-white/10 hover:text-white"
          >
            {category}
          </Link>
        ) : (
      ...
      {visibleTags.map((tag) =>
        linkFilters ? (
          <Link
            ...
            onClick={(e) => e.stopPropagation()}
            className="inline-flex rounded-md bg-white/[0.04] px-1.5 py-0.5 text-[10.5px] text-[#a8a8b2] ring-1 ring-white/8 transition-colors hover:bg-white/10 hover:text-white"
          >
            #{tag}
          </Link>
        ) : (
