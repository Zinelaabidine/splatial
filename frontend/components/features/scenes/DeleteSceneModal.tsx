...
export default function DeleteSceneModal({
  ...
  return (
    <div
      className="fixed inset-0 z-50 flex items-center justify-center bg-[var(--nord-scrim)] p-4 backdrop-blur-sm"
      onClick={onDismiss}
    >
      <div
      ...
      >
        <div className="mb-4 flex items-start gap-3">
          ...
          <div>
            <h2 className="text-base font-semibold text-[var(--nord-ink)]">Delete scene</h2>
            {activeJob ? (
              <>
                <p className="mt-1 text-sm text-[var(--nord-slate-soft)]">
        ...
        {error ? (
          <p className="mb-4 rounded-lg border border-[var(--nord-danger)] bg-red-50 px-3 py-2 text-sm text-red-600">
            {error}
          </p>
        ) : null}
        <div className="flex flex-col-reverse gap-2 sm:flex-row sm:justify-end">
          <button
            ...
            disabled={busy}
            onClick={onDismiss}
            className="rounded-lg border border-[var(--nord-hairline)] bg-[var(--nord-surface)] px-4 py-2 text-sm font-medium text-[var(--nord-ink)] transition-colors hover:bg-[var(--nord-surface-2)] disabled:opacity-50"
          >
            Keep scene
          </button>
          {activeJob && onCancelProcessing ? (
            <>
              <button
                ...
                className="rounded-lg border border-[var(--nord-danger)] bg-[var(--nord-surface)] px-4 py-2 text-sm font-medium text-red-700 transition-colors hover:bg-red-50 disabled:opacity-60"
              >
              ...
              <button
                ...
                className="rounded-lg bg-amber-600 px-4 py-2 text-sm font-medium text-[var(--nord-ink)] transition-colors hover:bg-[#f4ecd6] disabled:opacity-60"
              >
            ...
            <button
              ...
              disabled={busy}
              onClick={onConfirmDelete}
              className="rounded-lg bg-red-600 px-4 py-2 text-sm font-medium text-[var(--nord-cta-fg)] transition-colors hover:bg-red-700 disabled:opacity-60"
            >
