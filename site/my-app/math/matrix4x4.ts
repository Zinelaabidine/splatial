import type { CameraBlueprint } from "@/config/defaultCameras";
...
export function getViewMatrix(camera: CameraBlueprint): Matrix4 {
...
export function invert4(a: Matrix4): Matrix4 | null {
...
export function translate4(a: Matrix4, x: number, y: number, z: number): Matrix4 {
  return [
    ...a.slice(0, 12),
